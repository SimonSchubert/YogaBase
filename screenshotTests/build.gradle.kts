...
android {
    namespace = "com.inspiredandroid.yogabase.screenshots"
    compileSdk =
...
tasks.register("updateScreenshots") {
    ...
    doLast {
        val mapping = mapOf(
            ...
            "practiceIntro" to "screen_android_02.png",
            "practiceHolding" to "screen_android_03.png",
            "practiceHoldingMirrored" to "screen_android_04.png",
            "finish" to "screen_android_05.png",
        )
